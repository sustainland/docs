...
const siteConfig = {
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Labidi Aymen`,
  ...
  scripts: [
    ...
    // this.url + this.baseUrl + 'js/code-block-buttons.js',
  ],
  // stylesheets: [this.url + this.baseUrl + 'css/code-block-buttons.css'],
